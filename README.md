...
![待办事项页面](./assets/images/image-3.png)

### 2.3 文本推送

「文本推送」功能支持将文本内容直接推送到设备指定页面。

![文本推送页面](./assets/images/image-4.png)

### 2.4 图片推送

「图片推送」功能支持图片导入、编辑和推送。
![图片推送页面](./assets/images/image-5.png)

### 2.5 涂鸦推送

「涂鸦推送」功能支持在画布上自由绘制并推送。

![涂鸦推送页面](./assets/images/image-1.png)

### 2.6 自由排版

「自由排版」功能提供更灵活的文本排版选项。
![自由排版页面](./assets/images/image-6.png)
